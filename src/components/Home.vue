  ...
  <div>
    ...
    <transition name="slide-down">
      ...
      <section v-show="showUsageInstructions"
        ...
        <ul>
          <li>Install codemirror-mode ink from NPM: <code class="padding4">npm install codemirror-mode-ink</code></li>
          <li>Include codemirror-mode-ink into your project.
          ...
          <li>Set 'ink' as the mode when creating the CodeMirror editor.
...
<script>
  ...
  import '../../dist/codemirror-mode-ink'
  ...
  const inkOpts = Object.assign({}, htmlOpts, { mode: 'ink' })
  ...
  export default {
    ...
    mounted () {
      CodeMirror.fromTextArea(document.querySelector('#code'), inkOpts)
